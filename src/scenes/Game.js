...
import SimpleDialogueManager from '../classes/simpleDialogueManager';
...
export class Game extends Scene
{
    ...
    create ()
    {
        ...
        if (this.dialogueManager.isInDialogue()) {
            this.dialogueManager.handleKeyPress(event);
        }
    });
        ...
        this.dialogueManager = new SimpleDialogueManager(this);
